...
derivation {
  ...
  args = [
    ...
    (builtins.toFile "run.kaem" ''
      ...
      MES_PREFIX=./
      alias mescc="./bin/mes-m2 -e main ''${MESCC} -I include -I include/linux/x86 -c"
      ...
      catm  lib/x86-mes/libc-mini.a eputs.o oputs.o globals.o exit.o _exit.o _write.o puts.o strlen.o mini-write.o
      catm  lib/x86-mes/libc-mini.s eputs.s oputs.s globals.s exit.s _exit.s _write.s puts.s strlen.s mini-write.s
